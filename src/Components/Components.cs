...
public readonly record struct Origin(Vector2 Value);
...
public readonly record struct MoveTowardsPlayer();
public readonly record struct MovingTowardsPlayer(Vector2 startPosition);
